...
const Skeleton = () => {
  ...
  useEffect(() => {
    // @ts-expect-error :  Need to handle edge case for `any` type here
    animate(sequence, {
      repeat: Infinity,
      repeatDelay: 1,
    });
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto px-8 py-4 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
